...
namespace FondOfSpryker\Zed\TaxProductConnector\Business\Calculator;

use ArrayObject;
use Codeception\Test\Unit;
use FondOfSpryker\Zed\TaxProductConnector\Persistence\TaxProductConnectorQueryContainer;
...
{
    /**
     * @var \PHPUnit\Framework\MockObject\MockObject|\Spryker\Zed\TaxProductConnector\Dependency\Facade\TaxProductConnectorToTaxInterface
     */
    private $taxFacadeMock;

    /**
     * @var \PHPUnit\Framework\MockObject\MockBuilder|\FondOfSpryker\Zed\TaxProductConnector\Persistence\TaxProductConnectorQueryContainer
     */
    ...
    {
        $this->taxFacadeMock = $this->getMockBuilder(TaxProductConnectorToTaxInterface::class)
            ->getMock();


        $this->queryContainerMock = $this->getMockBuilder(TaxProductConnectorQueryContainer::class)
            ->onlyMethods([
